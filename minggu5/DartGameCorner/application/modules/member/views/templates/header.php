...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url() ?>member/dashboard">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<?= base_url(); ?>member/dashboard">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url(); ?>account/login/logout"><i class="fa-solid fa-arrow-right-to-bracket"></i> Logout</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="search-box">
                    <input type="search" class="search-txt" name="keyword">
